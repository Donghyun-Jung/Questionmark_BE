...
public class RoadmapControllerTest {
    ...
    @WithUserDetails(value = "lee@naver.com")
    @Test
    ...
    public void roadmap_group_find_success_test() throws Exception {
        ...
        // then
        result.andExpect(jsonPath("$.success").value("true"));
        result.andExpect(jsonPath("$.result.creator.name").value("lee"));
    ...
    public void roadmap_group_update_success_test() throws Exception {
        ...
        RoadmapRequest.ReferenceDTO webReference1 = new RoadmapRequest.ReferenceDTO(4L, "https://www.dongguk.edu/수정된 주소");
    ...
    @WithUserDetails(value = "hayeon@test.com")
    @Test
    public void roadmap_my_find_success_test () throws Exception {
        ...
        result.andExpect(jsonPath("$.result.roadmaps.duels[0].id").value(4L));
    }
    ...
    public void group_roadmap_participate_success_test() throws Exception{
        // given
        RoadmapRequest.ParticipateRoadmapDTO requestDTO = new RoadmapRequest.ParticipateRoadmapDTO("dgu12345");
    ...
    public void group_roadmap_participate_fail_test_1() throws Exception{
        // given
        RoadmapRequest.ParticipateRoadmapDTO requestDTO = new RoadmapRequest.ParticipateRoadmapDTO("dgu12347");
    ...
    @DisplayName("듀얼로드맵_참여하기_성공_test")
    @WithUserDetails(value = "lee@naver.com")
    @Test
    public void duel_roadmap_participate_success_test() throws Exception{
        ...
        // when
        ResultActions result = mvc.perform(
                post("/api/roadmaps/duel/" + id+ "/apply")
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
        );
    ...
    @DisplayName("듀얼로드맵_참여하기_실패_test1: 존재하지 않는 로드맵")
    @WithUserDetails(value = "lee@naver.com")
    @Test
    public void duel_roadmap_participate_fail_test_1() throws Exception{
    ...
    @DisplayName("듀얼로드맵_참여하기_실패_test2: 이미 속한 로드맵")
    @WithUserDetails(value = "lee@naver.com")
    @Test
    public void duel_roadmap_participate_fail_test_2() throws Exception{
    ...
    public void roadmap_members_find_success_test() throws Exception{
        ...
        // then
        result.andExpect(jsonPath("$.success").value("true"));
        result.andExpect(jsonPath("$.result.users[0].name").value("lee"));
...
//    }
    ...
    public void til_find_success_test_1() throws Exception {
        ...
        result.andExpect(jsonPath("$.result.members[1].submitDate").value("2024-05-21"));
    ...
    public void til_find_success_test_3() throws Exception {
        ...
        // then
        result.andExpect(jsonPath("$.success").value("true"));
        result.andExpect(jsonPath("$.result.members[0].name").value("lee"));
    }
    ...
    public void til_find_success_test_4() throws Exception {
        ...
        // then
        result.andExpect(jsonPath("$.success").value("true"));
        result.andExpect(jsonPath("$.result.members[1].name").value("masterLee"));
    }
    */
