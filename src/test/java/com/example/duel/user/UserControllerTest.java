...
public class UserControllerTest {
    ...
    public void user_email_check_success_test() throws Exception {
        ...
        // given
        UserRequest.CheckEmailDTO requestDTO = new UserRequest.CheckEmailDTO("hayeon1@test.com");
    ...
    public void user_send_email_code_success_test() throws Exception {
        ...
        // given
        UserRequest.SendEmailCodeDTO requestDTO = new UserRequest.SendEmailCodeDTO("hayeon@test.com");
    ...
    public void user_login_success_test() throws Exception {
        ...
        // given
        UserRequest.LoginDTO requestDTO = new UserRequest.LoginDTO("hayeon@test.com", "leeLee1!");
    ...
    public void user_login_fail_test_1() throws Exception {
        ...
        // given
        UserRequest.LoginDTO requestDTO = new UserRequest.LoginDTO("hayeon1@test.com", "test1234!");
    ...
    public void user_login_fail_test_2() throws Exception {
        ...
        // given
        UserRequest.LoginDTO requestDTO = new UserRequest.LoginDTO("hayeon@test.com", "Leelee123!");
    ...
    public void user_change_password_success_test() throws Exception {
        ...
        // given
        UserRequest.ChangePwdDTO requestDTO = new UserRequest.ChangePwdDTO("hayeon@test.com", "meta1234!!");
    ...
    public void user_change_password_fail_test_1() throws Exception {
        ...
        // given
        UserRequest.ChangePwdDTO requestDTO = new UserRequest.ChangePwdDTO("hayeon1@dgu.ac.kr", "meta1234!!");
    ...
    public void user_change_password_fail_test_2() throws Exception {
        ...
        // given
        UserRequest.ChangePwdDTO requestDTO = new UserRequest.ChangePwdDTO("hayeon@dgu.ac.kr", "meta1234");
